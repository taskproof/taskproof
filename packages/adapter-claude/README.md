...
- **Models:** `computer_20251124` + beta `computer-use-2025-11-24` for Opus 4.8/4.7/4.6,
  Sonnet 4.6, Opus 4.5; `computer_20250124` + beta `computer-use-2025-01-24` for Sonnet 4.5,
  Haiku 4.5, Opus 4.1, Sonnet 4.0, Opus 4.0. Default display is 1280×800, which keeps screenshot
  coordinates 1:1 on every model.
